<template>
  <div
    class="header"
    :class="{ 'header--small': $mq == 'mob' || $mq == 'ptab' }"
  >
    ...
    <div class="page-container">
      <div class="grid grid--middle grid--spread">
        <div
          class="grid__item"
          :class="{
            'grid__item--hide': $mq == 'ltab' || $mq == 'desk' || $mq == 'max'
          }"
        >
          <BurgerNavCross
            @clickedBurgerIcon="toggleNav"
        ...
        <div
          class="grid__item"
          :class="{ 'grid__item--hide': $mq == 'mob' || $mq == 'ptab' }"
        >
        ...
        <div
          class="grid__item grid__item--auto"
          :class="{ 'grid__item--hide': $mq == 'mob' || $mq == 'ptab' }"
        >
